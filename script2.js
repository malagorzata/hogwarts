...
function showDetails(student) {
  ...
  popWindow.querySelector(".house").textContent = student.house;
  ...
  if (student.squad === true) {
    popWindow.querySelector(".squad").textContent = `inquisitorial squad : Is member`;
  } else {
    popWindow.querySelector(".squad").textContent = `inquisitorial squad : Not member`;
  }
